...
if startup == True: #load classes
    ...
    class Pilot(pygame.sprite.Sprite):
        ...
        def maneuver(self):
            ...
            # self.rect.move((self.pos_x + self.momentum_x*0.1*self.mobility), (self.pos_y + self.momentum_y*0.1*self.mobility))
        def update(self):
            if self.invuln_timer > 0:
                self.invuln_timer -= 1
...
if startup == True: #load specifics 
    ...
    if startup == True: #add pointers
        mission_pointer_group.add(Pointer("rail", screen_width*0.6,screen_height*0.6,1))  
    class Overlay:
        def __init__(self, type):
            self.type = type
        ...
        def mission_setup(self, active_mission_number):
            ...
            if active_mission_number == 1:
                ...
                if mission_setup == True: #create train
                    ...
                    mission_objects_group.add(train_objective, self.waypoints)
